...
const Index = ({userDetails}) => {
   ...
   useEffect(() => {
    if(id){
        setLoading(true)
        axios.get(`https://mediumclonebackend.onrender.com/api/stories/${id}`).then((res) => {
   ...
   const addToList = async() => {
    ...
    await axios.post(`https://mediumclonebackend.onrender.com/api/user/list/${id}`,  body).then((res) => {
